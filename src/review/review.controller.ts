...
export class ReviewController {
  ...
  @ApiOperation({
    summary: '영화의 리뷰 불러오기',
    description: '특정 영화의 리뷰를 모두 불러옵니다.',
  })
  @ApiParam({
    name: 'movieId',
    description: '리뷰를 불러오고 싶은 영화의 아이디',
    type: Number,
  })
  @ApiOkResponse({
    type: ReviewEntity,
  ...
  findReviews(@Param('movieId') movieId: number) {
    console.log(movieId);
    return this.reviewService.findBookReviews(movieId);
  }
